...
const serviceData: Record<string, { title: string; description: string; image: string; features: string[]; longDescription: string }> = {
  ...
  "companionship": {
    ...
    longDescription: "Care is so much more than just physical support. It is about connection, laughter, and shared moments that make life rich. At Good Shepherd Home Care, our companionship service brings genuine friendship into the homes of those who need it most. Whether it is a chat over tea, looking through old photographs, or simply having someone to listen — our caregivers provide the social connection that makes every day brighter.",
    features: [
